...
import numpy as np
from communicator_objects import (AgentActionProto, EnvironmentParametersProto,
                                  UnityInput, UnityOutput,
                                  UnityRLInitializationInput,
                                  UnityRLInitializationOutput, UnityRLInput,
                                  UnityRLOutput)
from PIL import Image

from .brain import AllBrainInfo, BrainInfo, BrainParameters
from .curriculum import Curriculum
from .exception import (UnityActionException, UnityEnvironmentException,
                ...
                if not (
                    ...
                    raise UnityActionException(
                        ...
                        "The brain {0} expected {1} {2} action(s), but was provided: {3}".format(
                            ...
                            (
                                n_agent
                                if self._brains[b].vector_action_space_type
                                == "discrete"
                                else str(
                                    self._brains[b].vector_action_space_size * n_agent
                                )
