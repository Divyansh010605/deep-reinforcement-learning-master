from communicator_objects import (AgentInfoProto, BrainParametersProto,
                                  ResolutionProto, UnityInput, UnityMessage,
                                  UnityOutput, UnityRLInitializationOutput,
                                  UnityRLOutput)
...
class MockCommunicator(Communicator):
    ...
    def initialize(self, inputs: UnityInput) -> UnityOutput:
        ...
        rl_init = UnityRLInitializationOutput(
            name="RealFakeAcademy", version="API-4", log_path="", brain_parameters=[bp]
        )
    ...
    def exchange(self, inputs: UnityInput) -> UnityOutput:
        ...
        try:
            global_done = (
                inputs.rl_input.agent_actions["RealFakeBrain"]
                .value[0]
                .vector_actions[0]
                == -1
            )
