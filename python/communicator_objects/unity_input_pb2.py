...
from communicator_objects import \
    unity_rl_initialization_input_pb2 as \
    communicator__objects_dot_unity__rl__initialization__input__pb2
from communicator_objects import \
    unity_rl_input_pb2 as communicator__objects_dot_unity__rl__input__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        communicator__objects_dot_unity__rl__input__pb2.DESCRIPTOR,
        communicator__objects_dot_unity__rl__initialization__input__pb2.DESCRIPTOR,
    ],
)
...
_UNITYINPUT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="custom_data_input",
            full_name="communicator_objects.UnityInput.custom_data_input",
            index=2,
            number=3,
            type=5,
            cpp_type=1,
...
_UNITYINPUT.fields_by_name["rl_input"].message_type = (
    communicator__objects_dot_unity__rl__input__pb2._UNITYRLINPUT
)
_UNITYINPUT.fields_by_name["rl_initialization_input"].message_type = (
    communicator__objects_dot_unity__rl__initialization__input__pb2._UNITYRLINITIALIZATIONINPUT
)
