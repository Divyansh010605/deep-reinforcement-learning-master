...
from communicator_objects import \
    agent_info_proto_pb2 as communicator__objects_dot_agent__info__proto__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        communicator__objects_dot_agent__info__proto__pb2.DESCRIPTOR,
    ],
)
...
_UNITYRLOUTPUT = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _UNITYRLOUTPUT_LISTAGENTINFOPROTO,
        _UNITYRLOUTPUT_AGENTINFOSENTRY,
    ],
    enum_types=[],
    options=None,
    is_extendable=False,
...
_UNITYRLOUTPUT_LISTAGENTINFOPROTO.fields_by_name["value"].message_type = (
    communicator__objects_dot_agent__info__proto__pb2._AGENTINFOPROTO
)
_UNITYRLOUTPUT_LISTAGENTINFOPROTO.containing_type = _UNITYRLOUTPUT
_UNITYRLOUTPUT_AGENTINFOSENTRY.fields_by_name["value"].message_type = (
    _UNITYRLOUTPUT_LISTAGENTINFOPROTO
)
_UNITYRLOUTPUT_AGENTINFOSENTRY.containing_type = _UNITYRLOUTPUT
_UNITYRLOUTPUT.fields_by_name["agentInfos"].message_type = (
    _UNITYRLOUTPUT_AGENTINFOSENTRY
)
