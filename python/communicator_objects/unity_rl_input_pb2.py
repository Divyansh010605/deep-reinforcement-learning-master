...
from communicator_objects import \
    agent_action_proto_pb2 as \
    communicator__objects_dot_agent__action__proto__pb2
from communicator_objects import \
    command_proto_pb2 as communicator__objects_dot_command__proto__pb2
from communicator_objects import \
    environment_parameters_proto_pb2 as \
    communicator__objects_dot_environment__parameters__proto__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        communicator__objects_dot_agent__action__proto__pb2.DESCRIPTOR,
        communicator__objects_dot_environment__parameters__proto__pb2.DESCRIPTOR,
        communicator__objects_dot_command__proto__pb2.DESCRIPTOR,
    ],
)
...
_UNITYRLINPUT = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _UNITYRLINPUT_LISTAGENTACTIONPROTO,
...
_UNITYRLINPUT_LISTAGENTACTIONPROTO.fields_by_name["value"].message_type = (
    communicator__objects_dot_agent__action__proto__pb2._AGENTACTIONPROTO
)
_UNITYRLINPUT_LISTAGENTACTIONPROTO.containing_type = _UNITYRLINPUT
_UNITYRLINPUT_AGENTACTIONSENTRY.fields_by_name["value"].message_type = (
    _UNITYRLINPUT_LISTAGENTACTIONPROTO
)
_UNITYRLINPUT_AGENTACTIONSENTRY.containing_type = _UNITYRLINPUT
_UNITYRLINPUT.fields_by_name["agent_actions"].message_type = (
    _UNITYRLINPUT_AGENTACTIONSENTRY
)
_UNITYRLINPUT.fields_by_name["environment_parameters"].message_type = (
    communicator__objects_dot_environment__parameters__proto__pb2._ENVIRONMENTPARAMETERSPROTO
)
_UNITYRLINPUT.fields_by_name["command"].enum_type = (
    communicator__objects_dot_command__proto__pb2._COMMANDPROTO
)
