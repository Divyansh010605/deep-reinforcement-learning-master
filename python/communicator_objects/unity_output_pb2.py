...
from communicator_objects import \
    unity_rl_initialization_output_pb2 as \
    communicator__objects_dot_unity__rl__initialization__output__pb2
from communicator_objects import \
    unity_rl_output_pb2 as communicator__objects_dot_unity__rl__output__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        communicator__objects_dot_unity__rl__output__pb2.DESCRIPTOR,
        communicator__objects_dot_unity__rl__initialization__output__pb2.DESCRIPTOR,
    ],
)
...
_UNITYOUTPUT = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="custom_data_output",
            full_name="communicator_objects.UnityOutput.custom_data_output",
            index=2,
            number=3,
            type=9,
            cpp_type=9,
...
_UNITYOUTPUT.fields_by_name["rl_output"].message_type = (
    communicator__objects_dot_unity__rl__output__pb2._UNITYRLOUTPUT
)
_UNITYOUTPUT.fields_by_name["rl_initialization_output"].message_type = (
    communicator__objects_dot_unity__rl__initialization__output__pb2._UNITYRLINITIALIZATIONOUTPUT
)
