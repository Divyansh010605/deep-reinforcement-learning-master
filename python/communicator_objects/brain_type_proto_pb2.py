...
_BRAINTYPEPROTO = _descriptor.EnumDescriptor(
    ...
    values=[
        _descriptor.EnumValueDescriptor(
            name="Player", index=0, number=0, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="Heuristic", index=1, number=1, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="External", index=2, number=2, options=None, type=None
        ),
        _descriptor.EnumValueDescriptor(
            name="Internal", index=3, number=3, options=None, type=None
        ),
    ],
