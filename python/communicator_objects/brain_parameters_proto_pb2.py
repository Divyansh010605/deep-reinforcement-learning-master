...
from communicator_objects import \
    brain_type_proto_pb2 as communicator__objects_dot_brain__type__proto__pb2
from communicator_objects import \
    resolution_proto_pb2 as communicator__objects_dot_resolution__proto__pb2
from communicator_objects import \
    space_type_proto_pb2 as communicator__objects_dot_space__type__proto__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        communicator__objects_dot_resolution__proto__pb2.DESCRIPTOR,
        communicator__objects_dot_brain__type__proto__pb2.DESCRIPTOR,
        communicator__objects_dot_space__type__proto__pb2.DESCRIPTOR,
    ],
)
...
_BRAINPARAMETERSPROTO = _descriptor.Descriptor(
    ...
    fields=[
        ...
        _descriptor.FieldDescriptor(
            name="vector_observation_space_type",
            full_name="communicator_objects.BrainParametersProto.vector_observation_space_type",
            index=6,
            number=7,
            type=14,
            cpp_type=8,
        ...
        _descriptor.FieldDescriptor(
            name="brain_type",
            full_name="communicator_objects.BrainParametersProto.brain_type",
            index=8,
            number=9,
            type=14,
            cpp_type=8,
...
_BRAINPARAMETERSPROTO.fields_by_name["camera_resolutions"].message_type = (
    communicator__objects_dot_resolution__proto__pb2._RESOLUTIONPROTO
)
_BRAINPARAMETERSPROTO.fields_by_name["vector_action_space_type"].enum_type = (
    communicator__objects_dot_space__type__proto__pb2._SPACETYPEPROTO
)
_BRAINPARAMETERSPROTO.fields_by_name["vector_observation_space_type"].enum_type = (
    communicator__objects_dot_space__type__proto__pb2._SPACETYPEPROTO
)
_BRAINPARAMETERSPROTO.fields_by_name["brain_type"].enum_type = (
    communicator__objects_dot_brain__type__proto__pb2._BRAINTYPEPROTO
)
