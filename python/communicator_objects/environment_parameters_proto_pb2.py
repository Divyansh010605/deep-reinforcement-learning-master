...
_ENVIRONMENTPARAMETERSPROTO = _descriptor.Descriptor(
    ...
    extensions=[],
    nested_types=[
        _ENVIRONMENTPARAMETERSPROTO_FLOATPARAMETERSENTRY,
    ],
    enum_types=[],
    options=None,
    is_extendable=False,
...
_ENVIRONMENTPARAMETERSPROTO.fields_by_name["float_parameters"].message_type = (
    _ENVIRONMENTPARAMETERSPROTO_FLOATPARAMETERSENTRY
)
DESCRIPTOR.message_types_by_name["EnvironmentParametersProto"] = (
    _ENVIRONMENTPARAMETERSPROTO
)
